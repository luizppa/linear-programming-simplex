...
Original file is located at
    https://colab.research.google.com/drive/1tQ0JG-5rwlo9PjxZwBHfPbJy9HAD2SER
...
def solve(tableaux, previous_operations = None):
  ...
  while not is_optimal(tableaux):
    ...
    if is_negative(tableaux[:, pivot_col]):
      raise UnboundedLinearProgrammingError(get_unbounded_certificate(tableaux, pivot_col))
